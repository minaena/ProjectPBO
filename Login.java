...
public class Login extends javax.swing.JFrame {
    ...
    private void OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(this,"Mohon Diisi Dahulu.");

        }
        else if (user.getText().equals("Slebew") && password.getText().equals("321"))
        {
            Main m = new Main();  // Correct instantiation of Main class
        ...
        {
            JOptionPane.showMessageDialog(this,"Ussername atau Password tidak valid");
        }
